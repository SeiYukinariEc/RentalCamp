...
/**
 * Base class that represents a row from the 'sample_archive' table.
 *
 *
 *
 * @package    propel.generator.Common.Model.Base
 */
abstract class SampleArchive implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Common\\Model\\Map\\SampleArchiveTableMap';
    ...
    /**
     * Initializes internal state of Common\Model\Base\SampleArchive object.
     */
    ...
    /**
     * Compares this with another <code>SampleArchive</code> instance.  If
     * <code>obj</code> is an instance of <code>SampleArchive</code>, delegates to
     * <code>equals(SampleArchive)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|SampleArchive The current object, for fluid interface
     */
     ...
     * @return $this|\Common\Model\SampleArchive The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[SampleArchiveTableMap::COL_ID] = true;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[SampleArchiveTableMap::COL_NAME] = true;
        }
    ...
    public function setImage($v)
    {
        ...
        $this->modifiedColumns[SampleArchiveTableMap::COL_IMAGE] = true;
    ...
    public function setImageMeta($v)
    {
        ...
        if ($this->image_meta !== $v) {
            $this->image_meta = $v;
            $this->modifiedColumns[SampleArchiveTableMap::COL_IMAGE_META] = true;
        }
    ...
    public function setItemA($v)
    {
        ...
        if ($this->item_a !== $v) {
            $this->item_a = $v;
            $this->modifiedColumns[SampleArchiveTableMap::COL_ITEM_A] = true;
        }
    ...
    public function setItemB($v)
    {
        ...
        if ($this->item_b !== $v) {
            $this->item_b = $v;
            $this->modifiedColumns[SampleArchiveTableMap::COL_ITEM_B] = true;
        }
    ...
    public function setACategoryId($v)
    {
        ...
        if ($this->a_category_id !== $v) {
            ...
            $this->modifiedColumns[SampleArchiveTableMap::COL_A_CATEGORY_ID] = true;
        }
    ...
    public function setStickyFlag($v)
    {
        ...
        if ($this->sticky_flag !== $v) {
            $this->sticky_flag = $v;
            $this->modifiedColumns[SampleArchiveTableMap::COL_STICKY_FLAG] = true;
        }
    ...
    public function setDisableFlag($v)
    {
        ...
        if ($this->disable_flag !== $v) {
            $this->disable_flag = $v;
            $this->modifiedColumns[SampleArchiveTableMap::COL_DISABLE_FLAG] = true;
        }
    ...
    public function setFavoriteFlag($v)
    {
        ...
        if ($this->favorite_flag !== $v) {
            ...
            $this->modifiedColumns[SampleArchiveTableMap::COL_FAVORITE_FLAG] = true;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            if ($this->created_at === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->created_at->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[SampleArchiveTableMap::COL_CREATED_AT] = true;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            if ($this->updated_at === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->updated_at->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[SampleArchiveTableMap::COL_UPDATED_AT] = true;
            }
        } // if either are not null
    ...
    public function setArchivedAt($v)
    {
        ...
        if ($this->archived_at !== null || $dt !== null) {
            if ($this->archived_at === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->archived_at->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[SampleArchiveTableMap::COL_ARCHIVED_AT] = true;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : SampleArchiveTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : SampleArchiveTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : SampleArchiveTableMap::translateFieldName('ItemA', TableMap::TYPE_PHPNAME, $indexType)];
            $this->item_a = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : SampleArchiveTableMap::translateFieldName('ItemB', TableMap::TYPE_PHPNAME, $indexType)];
            $this->item_b = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : SampleArchiveTableMap::translateFieldName('ACategoryId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->a_category_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : SampleArchiveTableMap::translateFieldName('StickyFlag', TableMap::TYPE_PHPNAME, $indexType)];
            $this->sticky_flag = (null !== $col) ? (boolean) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : SampleArchiveTableMap::translateFieldName('DisableFlag', TableMap::TYPE_PHPNAME, $indexType)];
            $this->disable_flag = (null !== $col) ? (boolean) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 9 + $startcol : SampleArchiveTableMap::translateFieldName('FavoriteFlag', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 13; // 13 = SampleArchiveTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Common\\Model\\SampleArchive'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildSampleArchiveQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see SampleArchive::setDeleted()
     * @see SampleArchive::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildSampleArchiveQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                SampleArchiveTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(SampleArchiveTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(SampleArchiveTableMap::COL_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'name';
        }
        if ($this->isColumnModified(SampleArchiveTableMap::COL_IMAGE)) {
            $modifiedColumns[':p' . $index++]  = 'image';
        }
        if ($this->isColumnModified(SampleArchiveTableMap::COL_IMAGE_META)) {
            $modifiedColumns[':p' . $index++]  = 'image_meta';
        }
        if ($this->isColumnModified(SampleArchiveTableMap::COL_ITEM_A)) {
            $modifiedColumns[':p' . $index++]  = 'item_a';
        }
        if ($this->isColumnModified(SampleArchiveTableMap::COL_ITEM_B)) {
            $modifiedColumns[':p' . $index++]  = 'item_b';
        }
        if ($this->isColumnModified(SampleArchiveTableMap::COL_A_CATEGORY_ID)) {
            $modifiedColumns[':p' . $index++]  = 'a_category_id';
        }
        if ($this->isColumnModified(SampleArchiveTableMap::COL_STICKY_FLAG)) {
            $modifiedColumns[':p' . $index++]  = 'sticky_flag';
        }
        if ($this->isColumnModified(SampleArchiveTableMap::COL_DISABLE_FLAG)) {
            $modifiedColumns[':p' . $index++]  = 'disable_flag';
        }
        if ($this->isColumnModified(SampleArchiveTableMap::COL_FAVORITE_FLAG)) {
            $modifiedColumns[':p' . $index++]  = 'favorite_flag';
        }
        if ($this->isColumnModified(SampleArchiveTableMap::COL_CREATED_AT)) {
            $modifiedColumns[':p' . $index++]  = 'created_at';
        }
        if ($this->isColumnModified(SampleArchiveTableMap::COL_UPDATED_AT)) {
            $modifiedColumns[':p' . $index++]  = 'updated_at';
        }
        if ($this->isColumnModified(SampleArchiveTableMap::COL_ARCHIVED_AT)) {
            $modifiedColumns[':p' . $index++]  = 'archived_at';
        }

        $sql = sprintf(
            'INSERT INTO sample_archive (%s) VALUES (%s)',
    ...
    {
        $pos = SampleArchiveTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
    {
        ...
        if (isset($alreadyDumpedObjects['SampleArchive'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['SampleArchive'][$this->hashCode()] = true;
        $keys = SampleArchiveTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getName(),
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\Common\Model\SampleArchive
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Common\Model\SampleArchive The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(SampleArchiveTableMap::COL_ID)) {
            $criteria->add(SampleArchiveTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(SampleArchiveTableMap::COL_NAME)) {
            $criteria->add(SampleArchiveTableMap::COL_NAME, $this->name);
        }
        if ($this->isColumnModified(SampleArchiveTableMap::COL_IMAGE)) {
            $criteria->add(SampleArchiveTableMap::COL_IMAGE, $this->image);
        }
        if ($this->isColumnModified(SampleArchiveTableMap::COL_IMAGE_META)) {
            $criteria->add(SampleArchiveTableMap::COL_IMAGE_META, $this->image_meta);
        }
        if ($this->isColumnModified(SampleArchiveTableMap::COL_ITEM_A)) {
            $criteria->add(SampleArchiveTableMap::COL_ITEM_A, $this->item_a);
        }
        if ($this->isColumnModified(SampleArchiveTableMap::COL_ITEM_B)) {
            $criteria->add(SampleArchiveTableMap::COL_ITEM_B, $this->item_b);
        }
        if ($this->isColumnModified(SampleArchiveTableMap::COL_A_CATEGORY_ID)) {
            $criteria->add(SampleArchiveTableMap::COL_A_CATEGORY_ID, $this->a_category_id);
        }
        if ($this->isColumnModified(SampleArchiveTableMap::COL_STICKY_FLAG)) {
            $criteria->add(SampleArchiveTableMap::COL_STICKY_FLAG, $this->sticky_flag);
        }
        if ($this->isColumnModified(SampleArchiveTableMap::COL_DISABLE_FLAG)) {
            $criteria->add(SampleArchiveTableMap::COL_DISABLE_FLAG, $this->disable_flag);
        }
        if ($this->isColumnModified(SampleArchiveTableMap::COL_FAVORITE_FLAG)) {
            $criteria->add(SampleArchiveTableMap::COL_FAVORITE_FLAG, $this->favorite_flag);
        }
        if ($this->isColumnModified(SampleArchiveTableMap::COL_CREATED_AT)) {
            $criteria->add(SampleArchiveTableMap::COL_CREATED_AT, $this->created_at);
        }
        if ($this->isColumnModified(SampleArchiveTableMap::COL_UPDATED_AT)) {
            $criteria->add(SampleArchiveTableMap::COL_UPDATED_AT, $this->updated_at);
        }
        if ($this->isColumnModified(SampleArchiveTableMap::COL_ARCHIVED_AT)) {
            $criteria->add(SampleArchiveTableMap::COL_ARCHIVED_AT, $this->archived_at);
        }
    ...
    {
        $criteria = ChildSampleArchiveQuery::create();
        $criteria->add(SampleArchiveTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Common\Model\SampleArchive (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Common\Model\SampleArchive Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(SampleArchiveTableMap::DEFAULT_STRING_FORMAT);
    }
